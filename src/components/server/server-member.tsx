...
const roleIconMap = {
    ...
    [MemberRole.ADMIN]: <Shield className="h-4 w-4 ml-2 text-red-600"/>
}
...
const ServerMember = ({member,server}:ServerMemberProps) => {
  ...
  return (
    <div className={cn("group p-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
