...
import { Edit, Hash, Headset, Lock, Mic, Trash, Video } from "lucide-react"
...
const ServerChannel = ({channel,server,role}:ServerChannelProps) => {
  ...
  return (
    <div onClick={()=>{}}
     className={cn("group cursor-pointer px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
